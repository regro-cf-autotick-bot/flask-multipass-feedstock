...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-multipass-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12405&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-multipass-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-multipass` can be installed with:

```
conda install flask-multipass
```

It is possible to list all of the versions of `flask-multipass` available on your platform with:
